...
/**
 * REST controller for managing {@link ch.vaudoise.vaudoiseapi.exercice.domain.Person}.
 */
@RestController
...
public class PersonResource {
     ...
     */
    @GetMapping
    public ResponseEntity<List<PersonDTO>> getAllPeople(@ParameterObject Pageable pageable) {
